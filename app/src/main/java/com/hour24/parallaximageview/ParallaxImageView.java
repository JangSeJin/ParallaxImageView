...
public class ParallaxImageView extends ImageView {
    ...
    private String TAG = ParallaxImageView.class.getSimpleName();
    ...
    private boolean checkScale() {
        switch (getScaleType()) {
            ...
            case CENTER_INSIDE:
                return true;
            case FIT_CENTER:
                Log.e(TAG, "Scale type firCenter unsupported");
                break;
            case FIT_END:
                Log.e(TAG, "Scale type fitEnd unsupported");
                break;
            case FIT_START:
                Log.e(TAG, "Scale type fitStart unsupported");
                break;
            case FIT_XY:
                Log.e(TAG, "Scale type fitXY unsupported");
                break;
            case MATRIX:
                Log.e(TAG, "Scale type matrix unsupported");
                break;
        }
        return false;
    }
    ...
    private void checkAttributes(AttributeSet attrs) {
        TypedArray arr = getContext().obtainStyledAttributes(attrs, R.styleable.parallax_attrs);

        updateOnDraw = arr.getBoolean(R.styleable.parallax_attrs_update_onDraw, false);
